...
class TicketSell extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
          ->greeting('NEW Sell to: '.$this->arr['order']->name)
          ->line('User Email: '.$this->arr['order']->email)
          ->line('User Phone: '.$this->arr['order']->phone)
          ->line('Purchase of '.$this->arr['order']->item . ' is successful')
